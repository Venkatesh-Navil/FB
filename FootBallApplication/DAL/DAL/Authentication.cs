...
namespace DAL
{
    public class Authentication
    {
        ...
        public string GetConnection()
        {
            ...
            string connectionString = "Data Source=.\\SQLEXPRESS;Initial Catalog=FootballMaster;Integrated Security=True";//ConfigurationManager.ConnectionStrings["FootBallMasterConnection"].ConnectionString;
            return connectionString;
        }
